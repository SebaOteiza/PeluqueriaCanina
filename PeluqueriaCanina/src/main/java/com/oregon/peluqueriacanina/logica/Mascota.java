...
public class Mascota implements Serializable {
    ...
    public Mascota(String num_cliente, String nombre, String raza, String color, String alergico, String atencion_especial, String observaciones, Duenio unDuenio) {
